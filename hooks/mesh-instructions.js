...
function getFallbackInstructions(mode) {
  return 'AGENTMESH MODE ACTIVE — level: ' + mode + '\n\n' +
    ...
    '## Persistence\n\n' +
    'ACTIVE EVERY RESPONSE. No drift back to over-building. Still active if unsure. Off only: "stop mesh" or `/mesh off`.\n\n' +
    'Current level: **' + mode + '**. Switch: `/mesh lite|full|ultra`.\n\n' +
    '## The ladder\n\n' +
    ...
    'Mark deliberate simplifications that cut a real corner with a known ceiling, using a `mesh:` comment that names the ceiling and upgrade path.\n\n' +
    '## Output\n\n' +
    ...
    '## Boundaries\n\n' +
    'Agentmesh governs implementation cost and scope, not how you talk. "stop mesh" or `/mesh off`: revert. Level persists until changed or session end.';
}
